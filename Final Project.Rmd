...
phx <- geojson_read( "/Users/asiawoods/Documents/GitHub/CPP529/rdch_dorling.geojson", what="sp" )
...
phx2 <- merge( phx2, d3, by.x="GEOID", by.y="tractid", all.x=T )
```
...
phx2$cluster[ phx2$cluster == "1" ] <- "Non-Hispanic White, married, self-employed professionals who are home-owners with at least a Bachelor’s Degree"
phx2$cluster[ phx2$cluster == "2" ] <- "Multilingual, unemployed Native Americans with at least high school degrees that live in poverty
"
phx2$cluster[ phx2$cluster == "3" ] <- "Single-parent Native Americans that are female-headed, multi-family households and live in poverty"
phx2$cluster[ phx2$cluster == "4" ] <- "Elderly Non-Hispanic White Veterans"
phx2$cluster[ phx2$cluster == "5" ] <- "Non-Hispanic Black minors that live in neighborhoods created in the last ten years"
phx2$cluster[ phx2$cluster == "6" ] <- "Married  professionals with at least a Bachelor’s Degree"
phx2$cluster[ phx2$cluster == "7" ] <- "Multilingual, foreign Hispanic persons who live in poverty and have at least a high school diploma"
phx2$cluster[ phx2$cluster == "8" ] <- "Non-married persons who live in 30+ year structures and work in a primarily female labor force
"
